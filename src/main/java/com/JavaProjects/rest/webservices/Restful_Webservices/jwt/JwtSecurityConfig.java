package com.JavaProjects.rest.webservices.Restful_Webservices.jwt;
...
public class JwtSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                .authorizeHttpRequests(auth -> auth
                	.requestMatchers("/api/v2/authenticate").permitAll()
    ...
    {
        UserDetails user1 = creatNewUser("Jay", "{noop}vinayak");
        UserDetails user2 = creatNewUser("Raj", "{noop}siva");
